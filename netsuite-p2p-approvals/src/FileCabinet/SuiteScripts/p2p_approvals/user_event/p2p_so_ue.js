...
define([
...
], function(record, runtime, serverWidget, search, format, file, controller, historyLogger, constants) {
    'use strict';

    const BF = constants.BODY_FIELDS;
    const DETAILS_SUBTAB_ID = 'custom1904';
    const CLIENT_MODULE_PATH = '../client/p2p_so_cs.js';
    const CLIENT_FILE_PATH = '/SuiteScripts/p2p_approvals/client/p2p_so_cs.js';
    ...
    function setClientScript(form) {
        try {
            ...
            log.error('P2P SO client script missing', {
